...
- LLM and VLM inference systems
- Dynamic inference scheduling and execution policies
- KV-cache management, batching, and memory optimization
- GPU kernels and ML compilers
- Distributed and adaptive AI systems
- Reinforcement learning and optimization
- eBPF and kernel-level security
...
`Rust • C/C++ • Python • CUDA • Burn • CubeCL • eBPF • Distributed Systems • ML Systems • Optimization`
